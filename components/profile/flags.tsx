...
// Icons
import FlagCheck from "@/assets/icons/flag-check.svg";
import FlagExclamation from "@/assets/icons/flag-exclamation.svg";
    ...
    <div className="w-full flex flex-col gap-12">
      ...
      <div className="w-full flex flex-col">
        ...
        <Ul>
          ...
          <li>
            We <Bold>WILL</Bold> become gym buddies.
          </li>
        </Ul>
      </div>
    </div>
